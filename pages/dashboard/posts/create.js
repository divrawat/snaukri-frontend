...
export default function CreatePost() {
  ...
  // Load auth details & fetch tags/categories/locations
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const [catRes, tagRes, locRes, qualRes] = await Promise.all([
        ...
        if (catRes.ok && tagRes.ok && locRes.ok && qualRes.ok) {
    ...
    <div className={`min-h-screen p-8 transition-colors duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        ...
        {(() => {
          ...
          return (
            <form id="create-post-form" onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-5 gap-8">
              ...
              <div className="lg:col-span-1 space-y-6">
                ...
                <div className={`p-5 rounded-2xl border ${darkMode ? "bg-slate-950/20 border-slate-800" : "bg-white border-slate-200"}`}>
                  ...
                  <input
                    ...
                    className={`w-full border rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-indigo-500 ${
                      darkMode ? "bg-slate-955 border-slate-800 text-slate-100" : "bg-white border-slate-200 text-slate-955"
                    }`}
                  />
                </div>
                        ...
                        {uploadingImage ? (
                          ...
                          <>
                            ...
                            <p className="text-xs text-slate-400">
                              <span className="font-semibold text-indigo-450">Click to upload</span> image
                            </p>
                          </>
                        )}
                      </div>
